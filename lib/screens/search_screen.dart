    ...
    return GestureDetector(
      ...
      child: Scaffold(
          appBar: AppBar(
              ...
              title:  TitleTextWidget(label: passedCategory ?? "Ürünlerin Araması")
          ),
          body: productList.isEmpty
              ? const Center(child: TitleTextWidget(label: "Ürün Yok"),)
              :
          Padding(
            padding: const EdgeInsets.all(8.0),
            child: Column(
              children: [
                ...
                if(searchTextController.text.isNotEmpty && productListSearch.isEmpty)...[
                  const Center(
                    child: TitleTextWidget(label: "Ürün bulunamadı"),
                  )
                ],
