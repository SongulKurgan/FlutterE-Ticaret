...
import 'package:untitled/widgets/image_picker_widget.dart';
                ...
                child: Column(
                    children: [
                      ...
                      const Align(
                          ...
                          child: Column(
                            children: [
                              TitleTextWidget(label: "Hoşgeldiniz"),
                              SubTitleTextWidget(label: "Yeni bir hesap oluştur")
                            ],
                          )
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            TextFormField(
                              ...
                              obscureText: obscureText,
                              decoration:  InputDecoration(
                                  hintText: "Şifreyi tekrardan giriniz",
                                  prefixIcon: Icon ( IconlyLight.password),
                                  suffixIcon: IconButton(
                                    onPressed: (){
                                      setState(() {
